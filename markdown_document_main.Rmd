...
month_db <- list("january.csv", "february.csv", "march.csv", "april.csv", "may.csv", "june.csv", "july.csv", "august.csv", "september.csv", "october.csv", "november.csv", "december.csv")

myfiles<-lapply(month_db, function(x){ 
  read.table(unz(".\\monthly datasets\\monthly datasets.zip",x), header = TRUE, sep = ",")
  })
...
```{r merging}
year_2022 <- bind_rows(myfiles[1:12])
```
...
write.csv(year_2022v2, ".//results//cyclist_2022final.csv")
```
