...
T2mayapr <- list("april.csv", "may.csv")
myfilesT2mayapr<-lapply(T2mayapr, function(x){ 
  read.table(unz(".\\T2-may-apr.zip",x), header = TRUE, sep = ",")
  })
...
```{r merging}
#year_2022 <- bind_rows(T1[1:3],T2mayapr[1:2],T2jun[1:1],T3jul[1:1],  T3aug[1:1],T3sep[1:1], T4oct[1:1], T4novdec[1:2] )
year_2022 <- bind_rows(myfilesT1[1:3],myfilesT2jun[1:1], myfilesT3sep[1:1], myfilesT4oct[1:1], myfilesT4novdec[1:2] )
